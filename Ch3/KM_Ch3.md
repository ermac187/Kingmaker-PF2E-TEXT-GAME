...
## KM_Ch3.md | Split from the old consolidated bundle (v95.9 file-size remediation, 2026-05-29)
## Contains: Ch3 Varnhold Vanishing + Ch4–7 + Linzi Shrine of Returning
## Chapters 1-2 live in KM_Ch1.md (Stolen Land) and KM_Ch2.md (Troll Trouble / Bloom).
...
>
> **Councilor:** *"Varnhold has gone silent. Its regent — Maegar Varn — hasn't sent the weekly report in three weeks. Jamandi wants to know what happened."*
...
LOOT       : Wand of Displacement (south room), Ancient Rostlandic Coin (tavern crate),
             Two letters (story items — CRITICAL):
               Letter 1: Willas Gunderson found a strange amulet. Ends mid-sentence:
