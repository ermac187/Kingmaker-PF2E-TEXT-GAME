...
### E — Shackling
> Biggs unslings manacles without a word. Wedge follows. Malak: comply / resist (auto-lose to Biggs) / bolt. Player gets passage with Biggs's nod: *"Go on. We'll handle this."*
- Flags: `gate_entry=shackling`, `malak_arrested=TRUE`, `biggs_respect=TRUE`.
- Trigger ARREST CELEBRATION BEAT (full render — see legacy KM_PrePrologue_Crowd_B.md).
...
> 2+ turns elapsed; d6 roll 5–6 OR player explicitly stalls. Another invitee arrives. NOT a Pick-10 companion — DM picks Valeros or Kyra. They present letter cleanly. Witness to whatever has unfolded.
...
**Binding constraints:** PP_08 is the six-proof exit gate. All six proofs fire in ONE response (XP audit, XP total, state final, save block v1.7 exhaustive, wait-for-continue, next-scene declaration). Skipping any = cascade abandonment.
